...
public:
    ...
    static void getMemoryPoolPtr(nn::gfx::TBuffer<nn::gfx::ApiVariation<nn::gfx::ApiType<4>, const nn::gfx::ApiVersion<8>>>&);
    static void getMemoryPoolSize(const NVNmemoryPool*);
    static void calcMemoryPoolOffset(nn::gfx::TBuffer<nn::gfx::ApiVariation<nn::gfx::ApiType<4>, const nn::gfx::ApiVersion<8>>>&);
    static void getGPUAddressMemoryPool(NVNmemoryPool*);
    static void getGPUAddress(nn::gfx::TBuffer<nn::gfx::ApiVariation<nn::gfx::ApiType<4>, const nn::gfx::ApiVersion<8>>>&);
    static void getGPUAddressMemoryPool(nn::gfx::TBuffer<nn::gfx::ApiVariation<nn::gfx::ApiType<4>, const nn::gfx::ApiVersion<8>>>&);
    static void getGPUAddress(const agl::GPUMemVoidAddr&);
    static void getGPUAddress(const agl::ConstGPUMemVoidAddr&);
    static void getGPUAddress(const NVNbuffer&);
